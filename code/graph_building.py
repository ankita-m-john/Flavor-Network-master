...
df = pd.read_csv('/Users/ankita/Downloads/Flavor-Network-master/data/srep00196-s2.csv',skiprows=4,header=None)
...
recipe = pd.read_csv('/Users/ankita/Downloads/Flavor-Network-master/data/srep00196-s3.csv',skiprows=3,sep='\t')
...
df_backbone.to_csv('/Users/ankita/Downloads/Flavor-Network-master/data/backbone.csv',index=False)
