...
if __name__ == '__main__':
    yum = pd.read_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yummly.pkl')
    #drop duplicates
    ...
    yum.to_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yummly_clean.pkl')
    ...
    comp = pd.read_csv('/Users/ankita/Downloads/Flavor-Network-master/data/comp_info.tsv',index_col=0,sep='\t')
    ingr_comp = pd.read_csv('/Users/ankita/Downloads/Flavor-Network-master/data/ingr_comp.tsv',sep='\t')
    ingr = pd.read_csv('/Users/ankita/Downloads/Flavor-Network-master/data/ingr_info.tsv',index_col=0,sep='\t')
    ...
    yum_ingr.to_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yummly_ingr.pkl')
    yum_X.to_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yummly_ingrX.pkl')
    #get flavor profile
    ...
    pd.DataFrame(yum_flavor).to_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yum_flavor.pkl')
    pd.DataFrame(yum_tfidf).to_pickle('/Users/ankita/Downloads/Flavor-Network-master/data/yum_tfidf.pkl')
